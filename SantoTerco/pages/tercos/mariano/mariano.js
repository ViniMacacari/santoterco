...
if (id == 1){
    ...
    passagem4.innerHTML = "Quando se completaram os oito dias para a circuncisão do menino, deram-lhe o nome de Jesus, como fora chamado pelo anjo, antes deser concebido. Terminados os dias da purificação deles, conforme a Lei de Moisés, levaram o menino para Jerusalém, a fim de apresentá-lo ao Senhor, conforme está escrito na Lei do Senhor: 'Todo primogênito de sexo masculino será consagrado ao Senhor'. Foram também para oferecer em sacrifício um par de rolas ou dois pombinhos, conforme ordena a Lei do Senhor. <br> (Lc 2: 21-24)";
